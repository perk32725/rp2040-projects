...
uart_init:
    ...
    ldr     r1, =0x20000094 // interrupt_21 in vector table
    str     r0, [r1]        // modify interrupt_21

    // long call to setup_uart1:
    ldr     r1, =setup_uart1
...
_uart_done:
    ...
    ldr     r1, =uart1_rw   // base address for uart registers
